...
from models.rag_model import provide_feedback
...
@app.route('/start_interview/<job_title>')
def start_interview(job_title):
    # Generate questions for the specific job title
    questions = generate_questions_for_job(job_title)
    print("Job Title:", job_title)  # Debugging: Print job title
    print("Questions:", questions)  # Debugging: Print questions
...
def submit_answers():
    # Retrieve job title and answers from the form
    job_title = request.form['job_title']
    answers = request.form.getlist('answers')
    
    # Process answers to calculate feedback and score
    score, feedback = provide_feedback(answers)
    
    # Pass data to feedback.html
    return render_template('feedback.html', job_title=job_title, score=score, feedback=feedback)
